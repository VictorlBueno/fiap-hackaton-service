...
export class ProcessingJob {
    ...
    @ApiProperty({description: 'ID do usuário proprietário', example: 'user-123'})
    ...
    static createPending(id: string, videoName: string, userId: string): ProcessingJob {
    ...
    static createProcessing(id: string, videoName: string, userId: string): ProcessingJob {
        return new ProcessingJob(
            id,
            videoName,
    ...
    static createCompleted(id: string, videoName: string, userId: string, frameCount: number, zipPath: string): ProcessingJob {
        return new ProcessingJob(
            id,
            videoName,
            JobStatus.COMPLETED,
    ...
    static createFailed(id: string, videoName: string, userId: string, error: string): ProcessingJob {
        return new ProcessingJob(
            id,
            videoName,
            JobStatus.FAILED,
